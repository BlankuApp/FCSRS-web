...
export const defaultPrompts: DefaultPrompt[] = [
  {
    ...
    description: 'Replace `WRITE_STUDENT_LANGUAGE_HERE`, `WRITE_PROFICIENCY_HERE`, and `WRITE_CONTEXT_HERE` with the appropriate values.',
    content: `# Role
...
`,
  },
  {
    ...
    description: 'Replace `WRITE_TARGET_LANGUAGE_HERE`, `WRITE_STUDENT_LANGUAGE_HERE`, `WRITE_PROFICIENCY_HERE`, and `WRITE_CONTEXT_HERE` with the appropriate values.',
    content: `# Role
You are an expert language tutor who creates flashcards.
...
* Use **[target language]** for example sentences and final answers.`,
  },
  {
    ...
    description: 'Replace `WRITE_LEVEL_HERE`, `WRITE_COURSE_HERE`, and `WRITE_CONTEXT_HERE` with the appropriate values.',
    content: `# Role
...
* Always include units when relevant`,
  },
  {
    id: 'history-events',
    name: 'History & Events',
    description: 'Replace `WRITE_LEVEL_HERE`, `WRITE_REGION_HERE`, and `WRITE_CONTEXT_HERE` with the appropriate values.',
    content: `# Role
...
* Avoid presentism; use period-appropriate framing`,
  },
  {
    ...
    description: 'Replace `WRITE_LANGUAGE_HERE`, `WRITE_LEVEL_HERE`, and `WRITE_CONTEXT_HERE` with the appropriate values.',
    content: `# Role
...
* Put code in fenced markdown code blocks and keep snippets minimal`,
  },
  {
    ...
    description: 'Replace `WRITE_LEVEL_HERE`, `WRITE_SPECIALTY_HERE`, and `WRITE_CONTEXT_HERE` with the appropriate values.',
    content: `# Role
...
* Use markdown`,
  },
  {
    ...
    content: 'Make **6 to 8** flashcards about the **[topic]**.',
  },
];
